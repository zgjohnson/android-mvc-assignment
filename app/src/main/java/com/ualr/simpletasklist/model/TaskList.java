...
public class TaskList {
    ...
    // TODO 06.03. Define a new methods called "add" that, given a task description, will create a
    ...
    // TODO 07.03. Define a new methods called "delete" that, given a task id, will delete the
    //  corresponding task from the task list.

    // TODO 08.03. Define a new methods called "markDone" that, given a task id, will mark the
